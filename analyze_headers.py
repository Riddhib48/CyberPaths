...
them to a distribution of regular TCP traffic. Then appends the SRC IP most likely sending traffic to the csc_traffic_count list.
"""
...
def compare_to_regular_traffic(distributions, regular_dist):
    ...
    csc_traffic_count.append(largest_entropy_IP)
...
def main():
    ...
    for packet in packets:
        ...
        if packet.haslayer(TCP):
            ...
            if delta_time.total_seconds() > time_interval:
                ...
                compare_to_regular_traffic(distributions, regular_dist)
    ...
    IP_count = Counter(csc_traffic_count)
